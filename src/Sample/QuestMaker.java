...
public class QuestMaker {
    ...
    public static void fw() {
        ...
        String parentFolderPath = "C:\\Users\\1\\IdeaProjects\\gameJavaFX1\\src\\txtFiles\\ru";
        ...
        for(int level=0;level<countFiles;level++){
            ...
            try {
                File file = new File("C:\\Users\\1\\IdeaProjects\\gameJavaFX1\\src\\txtFiles\\ru\\" + level + "ru.txt");
            ...
            try {
                File file2 = new File("C:\\Users\\1\\IdeaProjects\\gameJavaFX1\\src\\txtFiles\\" + Subject.subjectEnum.getTitle() + "\\" + level + Subject.subjectEnum.getTitle() + ".txt");
